    ...
    <section className="main__feedback feedback">
      <div className="feedback__wrapper container">
        ...
        <dl className="feedback__list">
          ...
          <div className="feedback__item">
            <dd className="feedback__value">200 00 рублей</dd>
        ...
        <form action="#" className="feedback__form">
          <fieldset className="feedback__fieldset">
            <legend className="feedback__legend visually-hidden">Поля оформления заявки</legend>
            <label className="visually-hidden" htmlFor="name">Поле ввода имени</label>
            <input type="text" placeholder="ФИО" id="name" />
            <label className="visually-hidden" htmlFor="phone">Поле ввода телефона</label>
            <input type="text" placeholder="Телефон" id="phone" />
            <label className="visually-hidden" htmlFor="mail">Поле ввода электронной почты</label>
